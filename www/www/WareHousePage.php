...
<br>
		...
		<div id="content">
<?php
	$query = "SELECT o.orderID,p.productID,p.productName,o.quantity FROM orders o 
	...
	{		
		...
		{	
			...
			echo "<td>". $cRow['2']."</td>";
			echo "<td>". $cRow['3']."</td>";
			echo '<td><a href="http://localhost/form.php?onumber='.$cRow['0'].'" onClick="window.opener.location.reload();">Generate Invoice</a></td>';				
			echo "</tr>";
		}
		echo "</table>";
	}	
