...
<tr>
	...
	<td><input name="phonenumber" type="text" value="<?php echo $_POST[phonenumber]; ?>" style="width:260px" maxlength="50" /></td>
</tr>

<tr>
	<td style="width:150px"><strong>Place:</strong></td>

	<td><input name="place" type="text" value="<?php echo $_POST[place]; ?>" style="width:260px" maxlength="50" /></td>
</tr>
...
<td style="width:150px"><strong>Security Code:</strong></td>
	<td><img src="captcha/captcha.php" alt="Security-Code" title="michatronic-sicherheitscode" id="captcha" /><br />
	<a href="javascript:void(0);" onclick="javascript:document.getElementById('captcha').src='captcha/captcha.php?'+Math.random();"><span class="neuercode">New Code?</span></a></td>
</tr>
<tr>
...
</table><p style="font-size:11px"><!-- It´s not allowed to remove the copyright notice! -->&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><a href="http://www.kontaktformular.com/en" title="Contact Form">Contact Form</a></strong>: <a href="http://www.kontaktformular.com/en">&copy; kontaktformular.com</a> | <a href="http://www.knothemedia.de/backlinks-kaufen.html">Backlinks</a></p>
