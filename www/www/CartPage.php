...
if(isset($_POST['Cart']))
{
	...
	if($cRow['0'] >= $CheckQuantity)
	{
		...
		$Site = "'http://students.cs.niu.edu/~z1778592/OrderingSystem/OrderPage.php?Quantity=".$CheckQuantity."&ProductID=".$_SESSION['productID']."&OrderID=".$orderNumber."'";
	...
	else
	{
		...
		echo '<br>';
		echo '<a href = "http://students.cs.niu.edu/~z1778592/OrderingSystem/AddProducts.php"> Go back shopping!!!</a>';
	}	
}
?>
</div>
